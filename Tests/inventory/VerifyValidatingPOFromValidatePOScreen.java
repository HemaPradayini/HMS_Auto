...
public class VerifyValidatingPOFromValidatePOScreen {
	...
	//public void BeforeTest(){
	  ...
	  @BeforeMethod
		public void VerifyValidatingPOFromValidatePOScreenPreRequisite(){
			...
			login();
			DataSet = "PreReq_055";
			AutomationID = "VerifyValidatingPOFromValidatePOScreen";
			List<String> lineItemIDs = null;
			System.out.println("VerifyValidatingPOFromValidatePOScreen - Before Navigation");
			...
			//Set Use max cost price as Yes in generic preferences. 
			...
			genericPref.setPOValidation();
			genericPref.save();
	  }

	  
	  @Test()
		public void VerifyValidatingPOFromValidatePOScreen(){
			...
			pOApproval.searchPO();
			PurchaseOrder purchaseOrder = new PurchaseOrder(executeStep, verifications);
			purchaseOrder.ValidatePO();
			purchaseOrder.ValidatePOSave();
		
			
			System.out.println("Module Test TS_055 Completed");
