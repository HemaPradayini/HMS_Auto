...
public class VerifyToDeleteItemInPO {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - VerifyToDeleteItemInPO";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeMethod
		public void VerifyToDeleteItemInPOPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_054";
			AutomationID = "VerifyToDeleteItemInPO";
			...
			@Test()
			public void VerifyToDeleteItemInPO(){
				...
				//Click on "delete" icon at item list.
