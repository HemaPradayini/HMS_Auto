...
public class InvoiceDiscount {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - InvoiceDiscount";
	...
	//public void BeforeTest(){
	  ...
	  @Test()
	  public void InvoiceDiscountTest(){
		    openBrowser();
			login();
		    DataSet = "TS_025";
			AutomationID = "InvoiceDiscountTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test InvoiceDiscountTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("InvoiceDiscountTest workflow");
