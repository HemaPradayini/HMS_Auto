...
public class VATTaxTypeWithMB {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - VATTaxTypeWithMB";
	...
	//public void BeforeTest(){
	  private void login(){
	    ...
	    @BeforeClass
		public void VATTaxTypeWithMBPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_020";
			AutomationID = "VATTaxTypeWithMBPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithMBPreRequisite - Before Navigation");
	  ...
	  @Test()
		public void VATTaxTypeWithMBTest(){
		  
			DataSet = "TS_020";
			AutomationID = "VATTaxTypeWithMBTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithMBTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("VATTaxTypeWithMBTest workflow");
