...
public class VATTaxTypeWithOutMB {
	...
	//public void BeforeSuite(){
	  public void openBrowser(){
		...
		AutomationID = "Login - VATTaxTypeWithOutMB";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void VATTaxTypeWithOutMBPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_021";
			AutomationID = "VATTaxTypeWithOutMBPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithOutMBPreRequisite - Before Navigation");
	  ...
	  @Test()
		public void VATTaxTypeWithOutMBTest(){
		  
		  DataSet = "TS_021";
		  AutomationID = "VATTaxTypeWithOutMBTest";
		  List<String> lineItemIDs = null;
		  System.out.println("Inside Test VATTaxTypeWithOutMBTest - Before Navigation");
		  ...
		  testCaseStatus="PASS";
		  System.out.println("VATTaxTypeWithOutMBTest workflow");
	  }
	  ...
	  @AfterTest
		public void closeBrowser(){
	  	reporter.UpdateTestCaseReport(AutomationID, DataSet, " VATTaxTypeWithOutMBTest workflow", null, "", "", testCaseStatus);
	   // driver.close();
		}
