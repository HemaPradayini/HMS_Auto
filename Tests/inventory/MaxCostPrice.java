...
public class MaxCostPrice {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - MaxCostPrice";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeMethod
		public void MaxCostPricePreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_052";
			AutomationID = "MaxCostPrice";
			List<String> lineItemIDs = null;
			System.out.println("MaxCostPrice - Before Navigation");
			...
			//  * Issue Type = Consumable 
				...
				genericPref.UseMaxCostPriceDropdown();
				genericPref.save();
	  }        

				@Test()
				public void MaxCostPrice(){
