...
public class InventoryPurchaseOrderWithMRPBonus {
...
//public void BeforeSuite(){
  private void openBrowser(){
	...
	AutomationID = "Login - InventoryPurchaseOrderWithMRPBonus";
...
//public void BeforeTest(){
  ...
  @BeforeClass
	public void InventoryPurchaseOrderWithMRPBonusPreRequisite(){
		openBrowser();
		login();
		DataSet = "PreReq_005";
		AutomationID = "InventoryPurchaseOrderWithMRPBonusPreRequisite";
		List<String> lineItemIDs = null;
		System.out.println("Inside Test InventoryPurchaseOrderWithMRPBonusPreRequisite - Before Navigation");
  ...
  @Test()
	public void InventoryPurchaseOrderWithMRPBasedBonus(){
	  
		DataSet = "TS_005";
		AutomationID = "InventoryPurchaseOrderWithMRPBonus";
		List<String> lineItemIDs = null;
		System.out.println("Inside Test InventoryPurchaseOrderWithMRPBonus - Before Navigation");
		...
		testCaseStatus="PASS";
		System.out.println("InventoryPurchaseOrderWithMRPBonus workflow");
