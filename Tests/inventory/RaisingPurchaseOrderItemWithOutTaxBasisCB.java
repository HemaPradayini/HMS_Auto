...
public class RaisingPurchaseOrderItemWithOutTaxBasisCB {
	...
	//public void BeforeSuite(){
	  public void openBrowser(){
		...
		AutomationID = "Login - RaisingPurchaseOrderItemWithOutTaxBasisCB";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void RaisingPurchaseOrderItemWithOutTaxBasisCBPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_008";
			AutomationID = "RaisingPurchaseOrderItemWithOutTaxBasisCBPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test RaisingPurchaseOrderItemWithOutTaxBasisCBPreRequisite - Before Navigation");
	    ...
	    @Test()
		public void RaisingPurchaseOrderItemWithOutTaxBasisCBTest(){
		  
			DataSet = "TS_008";
			AutomationID = "RaisingPurchaseOrderItemWithOutTaxBasisCBTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test RaisingPurchaseOrderItemWithOutTaxBasisCBTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("RaisingPurchaseOrderItemWithOutTaxBasisCBTest workflow");
	  }
