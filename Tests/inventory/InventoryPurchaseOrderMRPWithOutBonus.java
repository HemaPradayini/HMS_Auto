...
public class InventoryPurchaseOrderMRPWithOutBonus {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - InventoryPurchaseOrderMRPWithOutBonus";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void InventoryPurchaseOrderMRPWithOutBonusPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_006";
			AutomationID = "InventoryPurchaseOrderMRPWithOutBonusPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test InventoryPurchaseOrderMRPWithOutBonusPreRequisite - Before Navigation");
	    ...
	    @Test()
		public void InventoryPurchaseOrderMRPBasedWithOutBonus(){
		  
		  DataSet = "TS_006";
			AutomationID = "InventoryPurchaseOrderMRPBasedWithOutBonus";
			List<String> lineItemIDs = null;
			...
			testCaseStatus="PASS";
			System.out.println("InventoryPurchaseOrderWithOutBonus workflow");
			
	  }
	  
	  @AfterTest
		public void closeBrowser(){
	  	reporter.UpdateTestCaseReport(AutomationID, DataSet, " InventoryPurchaseOrderWithOutBonus workflow", null, "", "", testCaseStatus);
			//driver.close();
		}
