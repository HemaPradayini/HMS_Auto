...
public class CEDCalculations {
	...
	//public void BeforeTest(){
	  private void login(){
		AutomationID = "Login - CEDCalculations";
		DataSet = "PreReq_010";
	  ...
	  @BeforeClass
		public void CEDCalculationsPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_010";
			AutomationID = "CEDCalculationsPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test CEDCalculationsPreRequisite - Before Navigation");
	    ...
	    @Test()
		public void CEDCalculationsTest(){
		  
			DataSet = "TS_010";
			AutomationID = "CEDCalculationsTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test CED_CalculationsTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("CED_CalculationsTest workflow");
	  }
     ...
     public void PurchaseOrderTotalAndTax(String lineItemId){
	  ...
	  @AfterTest
		public void closeBrowser(){
	  	reporter.UpdateTestCaseReport(AutomationID, DataSet, " CED_CalculationsTest workflow", null, "", "", testCaseStatus);
	    //driver.close();
		}
	}
