...
public class BonusQtyRate {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - BonusQtyRate";
	...
	//public void BeforeTest(){
	  ...
	  @Test()
	  public void BonusQtyRateTest(){
		    openBrowser();
			login();
			DataSet = "TS_027";
			AutomationID = "BonusQtyRateTest";
			...
			testCaseStatus="PASS";
			System.out.println("BonusQtyRateTest workflow");
