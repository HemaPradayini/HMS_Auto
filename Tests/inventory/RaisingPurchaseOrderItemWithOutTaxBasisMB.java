...
public class RaisingPurchaseOrderItemWithOutTaxBasisMB {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - RaisingPurchaseOrderItemWithOutTaxBasisMB";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void RaisingPurchaseOrderItemWithOutTaxBasisMBPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_006";
			AutomationID = "RaisingPurchaseOrderItemWithOutTaxBasisMBPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test RaisingPurchaseOrderItemWithOutTaxBasisMBPreRequisite - Before Navigation");
			...
			//6. In Supplier Masters, add 'Supplier_1' with Credit Period and Address --In Spplier Masters.
	    ...
	    @Test()
		public void RaisingPurchaseOrderItemWithOutTaxBasisMBTest(){
		  
		  DataSet = "TS_006";
			AutomationID = "RaisingPurchaseOrderItemWithOutTaxBasisMBTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test InventoryPurchaseOrderMRPBasedWithOutBonus - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("RaisingPurchaseOrderItemWithOutTaxBasisMBTest workflow");
	    ...
	    public void PurchaseOrderTotalAndTax(String lineItemId){
			...
			for(int i=1; i<=rowCount; i++){	
				...
				verifications.verify(SeleniumVerifications.Appears, "Total","PurchaseOrderItemWithoutMBTaxBasisTotal",false);
				verifications.verify(SeleniumVerifications.Appears, "TaxAmt","PurchaseOrderItemWithoutMBTaxBasisTaxAmt",false);
	  ...
	  @AfterTest
		public void closeBrowser(){
	  	reporter.UpdateTestCaseReport(AutomationID, DataSet, " RaisingPurchaseOrderItemWithOutTaxBasisMBTest workflow", null, "", "", testCaseStatus);
			driver.close();
		}
