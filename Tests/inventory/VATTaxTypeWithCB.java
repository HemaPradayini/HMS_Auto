...
public class VATTaxTypeWithCB {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - VATTaxTypeWithCB";
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void VATTaxTypeWithCBPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_022";
			AutomationID = "VATTaxTypeWithCBPreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithCBPreRequisite - Before Navigation");
	  ...
	  @Test()
		public void VATTaxTypeWithCBTest(){
		  
			DataSet = "TS_022";
			AutomationID = "VATTaxTypeWithCBTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithCBTest - Before Navigation");
			...
			testCaseStatus="PASS";
			  System.out.println("VATTaxTypeWithCBTest workflow");
		  }
	  ...
	  public void PurchaseOrderTotalAndTax(String lineItemId){
		  ...
		  @AfterTest
			public void closeBrowser(){
		  	reporter.UpdateTestCaseReport(AutomationID, DataSet, " VATTaxTypeWithCBTest workflow", null, "", "", testCaseStatus);
		   // driver.close();
			}
