...
public class RaiseSupplierReturnWithDebitNotes {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - RaiseSupplierReturnWithDebitNotes";
	...
	//public void BeforeTest(){
	  private void login(){
		...
		//verifications.verify(SeleniumVerifications.Appears, "NavigationMenu", "" , false);
	 	  ...
	 	  @BeforeClass
		public void RaiseSupplierReturnWithDebitNotesPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_037";
			AutomationID = "RaiseSupplierReturnWithDebitNotes";
	...
	/*	itemCat.AddItemcategory("Itemcategory", false);
		...
		*/    navigation.navigateTo(driver, "SupplierReturnsWithDebitNotesLink", "SupplierReturnsWithDebitNotesPage");  
		//15. Supplier Return (With Debit Note) screen should be opened.
		    ...
		    @Test(priority = 1)
			public void raiseSupplierReturnWithDebitNotes(){
			  
			  
				DataSet = "TS_037";
				AutomationID = "RaiseSupplierReturnWithDebitNotes";
				List<String> lineItemIDs = null;
				System.out.println("Inside Test RaiseSupplierReturnWithDebitNotes - Before Navigation");
			...
			//	1. Click on "Raise New Debit Note " link.
//				2. Ensure that Supplier return (debit) sccreen is opened.
			...
			//	3. Select Return Against:Without GRN No radio button 
				
			//	4. Enter the return details such as "supplier, store, return type, remarks, 
			...
			//	5. "add item" which is to be returned and enter the returned qty.
				supRetDebit.addItem("SupplierReturnDebit");
			//	6. Click on "update" note.   
