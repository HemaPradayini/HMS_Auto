...
public class VerifyCEDAmountInStockEntry {
	...
	//@BeforeSuite
		//public void BeforeSuite(){
		  private void openBrowser(){
			...
			AutomationID = "Login - CED_Calculations";
		...
		//public void BeforeTest(){
		  private void login(){
			AutomationID = "Login - VerifyCEDAmountInStockEntry";
			DataSet = "PreReq_028";
		  ...
		  @BeforeClass
			public void VerifyCEDAmountInStockEntryPreRequisite(){
				openBrowser();
				login();
				DataSet = "PreReq_028";
				AutomationID = "VerifyCEDAmountInStockEntryPreRequisite";
				List<String> lineItemIDs = null;
				System.out.println("Inside Test VerifyCEDAmountInStockEntryPreRequisite - Before Navigation");
		    	...
		    	//2. -> Create a batch Item Category in Item Category Master under stores master 
		    ...
		    @Test()
			public void VerifyCEDAmountInStockEntryTest(){
			  
				DataSet = "TS_028";
				AutomationID = "VerifyCEDAmountInStockEntryTest";
				List<String> lineItemIDs = null;
				System.out.println("Inside Test VerifyCEDAmountInStockEntryTest - Before Navigation");
				...
				testCaseStatus="PASS";
				System.out.println("VerifyCEDAmountInStockEntryTest workflow");
		  }
	     ...
	     public void PurchaseOrderTotalAndTax(String lineItemId){
		  ...
		  @AfterTest
			public void closeBrowser(){
		  	reporter.UpdateTestCaseReport(AutomationID, DataSet, "VerifyCEDAmountInStockEntryTest workflow", null, "", "", testCaseStatus);
		    //driver.close();
			}
		}
