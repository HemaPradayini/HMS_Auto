...
public class CSTTaxType {
	...
	//public void BeforeTest(){
	  ...
	  @BeforeClass
		public void CSTTaxTypePreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_009";
			AutomationID = "CSTTaxTypePreRequisite";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test CSTTaxTypePreRequisite - Before Navigation");
	  ...
	  @Test()
		public void CSTTaxTypeTest(){
		  
			DataSet = "TS_009";
			AutomationID = "CSTTaxTypeTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test CSTTaxTypeTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("CSTTaxTypeTest workflow");
	  }
