...
public class ReplaceAllItemForSupplierReturn {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - ReplaceAllItemForSupplierReturn";
	...
	//public void BeforeTest(){
	  private void login(){
		...
		//verifications.verify(SeleniumVerifications.Appears, "NavigationMenu", "" , false);
	 	  ...
	 	  @BeforeClass
		public void ReplaceAllItemForSupplierReturnPreRequisite(){
			openBrowser();
			login();
			DataSet = "PreReq_034";
			AutomationID = "ReplaceAllItemForSupplierReturn";
	 	  ...
	 	  */
		 	 ...
		 	 @Test(priority = 1)
				public void RaiseNewSupplierReturn(){
					...
					suppReplace.replaceSupplier1("ReplaceSupplier1",false);
					suppReplace.replaceSupplier2("ReplaceSupplier2",false);
					suppReplace.replaceSupplier3("ReplaceSupplier3",false);
