...
public class VATTaxTypeWithCST {
	...
	//public void BeforeSuite(){
	  private void openBrowser(){
		...
		AutomationID = "Login - VATTaxTypeWithCST";
	...
	//public void BeforeTest(){
	  ...
	  @Test()
		public void VATTaxTypeWithCSTTest(){
		    openBrowser();
			login();
			DataSet = "TS_024";
			AutomationID = "VATTaxTypeWithCSTTest";
			List<String> lineItemIDs = null;
			System.out.println("Inside Test VATTaxTypeWithCSTTest - Before Navigation");
			...
			testCaseStatus="PASS";
			System.out.println("VATTaxTypeWithCSTTest workflow");
